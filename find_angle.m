function [angle_lef, angle_rig, height, ses_pts] = find_angle(I, thresh_inc, para_length, known_dist) 
   ...
   %Trace boundaries down from the apex:
        %cd C:\Users\RAGHU ADITYA\Desktop/Sessile_detection; 
        cut_off = 5;
        ...
        plot(X_rig,f_rig_val,'g'); hold on;
        ...
        [f_lef, f_rig, f_line, f_lef_val, f_rig_val, f_line_val, X_lef, X_rig, X_line] = poly_line(boundary_left, boundary_right, max(boundary_right(:,1)));
    ...
    [angle_rig, sol_x_rig] = derive_angle(f_rig, f_line, I, 'right', (boundary_right()))
